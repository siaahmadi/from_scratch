# List of mathematical derivations included in this repo

These PDF files detail every step of deriving the deep learning tools from the basic mathematical functions, which can be directly implemented using NumPy alone without autograd.
